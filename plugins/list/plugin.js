...
( function() {
    ...
    /**@author alissa  added address, div and p tags, so that when you create a list you will have them inside the list*/
	...
	listCommand.prototype = {
		exec: function( editor ) {
            ...
            /** @author alissa add an event for list change so that we can apply the text styles on the numbers/bullets */
